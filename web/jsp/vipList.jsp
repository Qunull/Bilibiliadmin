    ...
    <div class="layuimini-main">
        <fieldset class="layui-elem-field layuimini-search">
            ...
            <div style="margin: 10px 10px 10px 10px">
                <form class="layui-form layui-form-pane" action="/vip" method="post">
                    <input type="hidden" name="opr" value="userList">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">用户编号</label>
                            <div class="layui-input-inline">
                                <input type="text" name="userId" autocomplete="off" class="layui-input" value="${vipId}">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">用户姓名</label>
                            <div class="layui-input-inline">
                                <input type="text" id="userName" name="userName" autocomplete="off" class="layui-input" value="${vipName}">
                            </div>
                        </div>
                        <div class="layui-inline">
