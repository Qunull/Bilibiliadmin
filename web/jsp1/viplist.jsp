    ...
    <div class="layuimini-main">
        <fieldset class="layui-elem-field layuimini-search">
            ...
            <div style="margin: 10px 10px 10px 10px">
                <form class="layui-form layui-form-pane" action="/vip/getvList" method="post">
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                layer.open({
                    ...
                    , title: '修改'
                    , area: ['600px', '600px']
                    , content: '../vip/vipModify?userId='+data.userId
                });
                layer.close(index);
