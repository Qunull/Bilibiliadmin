                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="auditorName" name="auditorName"value="${auditor.auditorName}" autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                            <label class="layui-form-label">昵称</label>
                            <div class="layui-input-inline">
                                <input type="text" id="auditorAuthor" name="auditorAuthor"value="${auditor.auditorAuthor}" autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                            <label class="layui-form-label">电话</label>
                            <div class="layui-input-inline">
                                <input type="text" id="phone" name="phone" value="${auditor.phone}"autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                            <label class="layui-form-label">性别</label>
                            <div class="layui-input-inline">
                                <c:if test="${auditor.gender ==1}">
                                    <input type="radio" name="gender" class="gender" value="1" checked>男
                                    <input type="radio" name="gender" class="gender" value="2">女
                                </c:if>
                                <c:if test="${auditor.gender ==2}">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="birthday" name="birthday" value="${auditor.birthday}"autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="memo" name="memo"value="${auditor.memo}" autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-btn-group">
                            <input type="hidden" id="auditorId" value="${auditor.auditorId}">
