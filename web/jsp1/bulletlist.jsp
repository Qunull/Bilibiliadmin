    ...
    <div class="layuimini-main">
        ...
        <fieldset class="layui-elem-field layuimini-search">
            ...
            <div style="margin: 10px 10px 10px 10px">
                <form class="layui-form layui-form-pane" action="/bullet/getBList.html">
        ...
        <%--<table class="layui-table">
            ...
            <c:forEach var="bullet" items="${bulletList}" varStatus="status">
                <tr>
                    <td>${bullet.userId}</td>
                    <td>${bullet.videoId}</td>
                    <td>${bullet.content}</td>
                    <td>${bullet.memo}</td>
                    <td class="td-manage">
                        <a title="修改" onclick="">
                            <i class="layui-icon">&#xe63c;</i>
                        </a>
                        <a title="删除" onclick="member_del(this,'要删除的id')" href="/bullet/delBullet?id=${bullet.id}">
                            <i class="layui-icon">&#xe640;</i>
                        </a>
                    </td>
                </tr>
...
<script>
    ...
    layui.use(['form', 'table'], function () {
        ...
        <c:forEach items="${bulletList}" var= "bullet">
        var module = {"id":"${bullet.id}",
