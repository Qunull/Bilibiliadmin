                ...
                <form class="layui-form layui-form-pane" id="updateForm">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="userAuthor" name="userAuthor"value="${user.userAuthor}" autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="userAutograph" name="userAutograph" value="${user.userAutograph}"autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                            <label class="layui-form-label">会员生效时间</label>
                            <div class="layui-input-inline">
                                <input type="text" id="startTime" name="startTime" value="${user.startTime}"autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                            <label class="layui-form-label">会员失效时间</label>
                            <div class="layui-input-inline">
                                <input type="text" id="endTime" name="endTime" value="${user.endTime}"autocomplete="off" class="layui-input">
                            </div>
                        </div><br>
                        <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="memo" name="memo"value="${user.memo}" autocomplete="off" class="layui-input">
                            </div>
                        </div>
                    </div><br>
    ...
    layui.use(['form'], function () {
        ...
        form.on('submit(add)',function () {
            ...
            $.each(formArray,function(i,item){
                ...
                var userAutograph=$("#userAutograph").val();
