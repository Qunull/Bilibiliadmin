    ...
    <div class="layuimini-main">
        <fieldset class="layui-elem-field layuimini-search">
            ...
            <div style="margin: 10px 10px 10px 10px">
                <form class="layui-form layui-form-pane" action="/staff/StaffList.html" method="post">
...
<script>
    ...
    layui.use(['form', 'table'], function () {
        ...
        <c:forEach items="${staffList}" var= "adt">
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                layer.open({
                    ...
                    , title: '修改'
                    , area: ['600px', '600px']
                    , content: '../staff/getStaffById?auditorId='+data.auditorId
                });
                //layer.close(index);
