                                            ...
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins">${auditorCount}</h1>
                                        ...
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins">${voderdsCount}</h1>
                                                        <small>当前视频未审核总记录数</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="layui-col-xs6">
                                            <div class="panel layui-bg-number">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="panel-content">
                                                        <h1 class="no-margins">${vodertgCount}</h1>
